...
class AgentImageFromApiAdapter(
    private val images: ArrayList<com.property.propertyagent.modal.agent.agent_assigned_property_details.Document>,
    val onItemClicked: (Int, Int) -> Unit,
) : RecyclerView.Adapter<AgentImageFromApiAdapter.ViewHold>() {
