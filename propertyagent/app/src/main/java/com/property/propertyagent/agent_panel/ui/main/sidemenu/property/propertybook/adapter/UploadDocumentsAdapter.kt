package com.property.propertyagent.agent_panel.ui.main.sidemenu.property.propertybook.adapter
...
class UploadDocumentsAdapter(
...
) : RecyclerView.Adapter<UploadDocumentsAdapter.ViewHold>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHold {
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.recycer_image_upload_item, parent, false)
        return ViewHold(
            view
        )
    }
