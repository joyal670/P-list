package com.property.propertyagent.owner_panel.ui.main.sidemenu.maintenance.service.service_detailed_page.adapter
...
class UploadServiceDocumentsAdapter(
    context: Context,
    private val images: ArrayList<Uri?>,
    val onItemClicked: (Int) -> Unit) : RecyclerView.Adapter<UploadServiceDocumentsAdapter.ViewHold>()
{
