...
class image_upload_adapter(
    addpropertypage3Activity: Activity,
    private val images: ArrayList<Uri?>,
    val onItemClicked: (Int) -> Unit) : RecyclerView.Adapter<image_upload_adapter.ViewHold>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHold
    {
        ...
        val view = LayoutInflater.from(parent.context).inflate(com.property.propertyagent.R.layout.recycer_image_upload_item, parent, false)
        return ViewHold(
            view
        )
    }
