package com.ncomfortsagent.cloud_messaging
...
const val channelId = "com.ncomfortsagent.push_notify"
const val channelName = "com.ncomfortsagent.notify"
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    private fun getRemoteView(title: String, message: String): RemoteViews {
        remoteViews = RemoteViews("com.ncomfortsagent", R.layout.push_notification_layout)
