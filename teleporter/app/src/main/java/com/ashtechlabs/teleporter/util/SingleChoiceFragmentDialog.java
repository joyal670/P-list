...
public class SingleChoiceFragmentDialog extends DialogFragment implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        dialog.dismiss();
        singleChoiceItemDialogListener = (SingleChoiceItemDialogListener) getTargetFragment();
