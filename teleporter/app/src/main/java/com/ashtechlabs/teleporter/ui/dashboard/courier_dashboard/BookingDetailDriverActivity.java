...
public class BookingDetailDriverActivity extends BaseActivity implements OnMapReadyCallback,
    ...
    private void setUpToolbar() {
        ...
        setTitle("Booking Detail Driver");
    ...
    private void displayData() {
        MyLogsAndOrderInfoDriver myLogsAndOrderInfoDriver = null;
        ...
        try {
            ...
            txtTime.setText(myLogsAndOrderInfoDriver.getTime());
            txtDate.setText(myLogsAndOrderInfoDriver.getDate());
            txtItemType.setText(myLogsAndOrderInfoDriver.getItemtype());
    ...
    private void displayDirverLocation() {
        ...
        if (mLastLocation != null) {
            ...
            IMapFragmentController.onUpdateDriverLocation(GlobalPreferManager.getString(GlobalPreferManager.Keys.TOKEN_COURIER, ""), GlobalUtils.MODE_COURIER, String.valueOf(latitude), String.valueOf(longitude));
        }
    }
