...
public class CompletedDecorator implements DayViewDecorator {
    ...
    public CompletedDecorator(Activity activity, ArrayList<CalendarDay> dates) {
        drawable = ContextCompat.getDrawable(activity, R.drawable.bg_date_round_border_complete);
        date = dates;
    }
