...
class EventFreezeDecorator(context: Activity?, dates: ArrayList<CalendarDay>, var calenderType: ArrayList<String>, var remoDate:String) :
    DayViewDecorator
{
    ...
    init {
        ...
        drawablePause = ContextCompat.getDrawable(context!!, R.drawable.bg_date_round_border_freez)
    }
}
