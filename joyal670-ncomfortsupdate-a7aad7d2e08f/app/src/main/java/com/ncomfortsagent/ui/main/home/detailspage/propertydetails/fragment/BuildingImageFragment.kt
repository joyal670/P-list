...
import com.ncomfortsagent.dialog.FullScreenBuildingImageDialogFragment
import com.ncomfortsagent.model.building_details.AgentBuildingDetailsDocument


class BuildingImageFragment : BaseFragment() {
    ...
    companion object {
        ...
        private var doc = ArrayList<AgentBuildingDetailsDocument>()

        @JvmStatic
        fun newInstance(image: String, imageList: ArrayList<AgentBuildingDetailsDocument>) =
            BuildingImageFragment().apply {
    ...
    override fun onClicks() {
        binding.ownerImageSlider.setOnClickListener {
            val dialog = FullScreenBuildingImageDialogFragment(requireActivity(), doc)
