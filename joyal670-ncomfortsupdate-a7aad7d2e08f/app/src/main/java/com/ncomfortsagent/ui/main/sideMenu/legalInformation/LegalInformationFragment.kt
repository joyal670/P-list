package com.ncomfortsagent.ui.main.sideMenu.legalInformation
...
import com.ncomfortsagent.databinding.FragmentLegalInformationBinding
...
class LegalInformationFragment : BaseFragment()
{
    private lateinit var binding: FragmentLegalInformationBinding
    ...
    override fun setView(
        ...
        binding = FragmentLegalInformationBinding.inflate(inflater!!, container, false)
        return binding.root
    }
    ...
    override fun initData() {
        ...
        fragmentTransInterface.setTitleFromFragment(getString(R.string.legal_information))
    }
    ...
    override fun setupUI() {
        ...
        if(AppPreferences.user_lang== Constants.ARABIC_LAG){
            binding.webView.loadUrl("http://ncomfort.iroidtechnologies.in/show-user-legal/2")
        }else{
            binding.webView.loadUrl("http://ncomfort.iroidtechnologies.in/show-user-legal/1")
        }
