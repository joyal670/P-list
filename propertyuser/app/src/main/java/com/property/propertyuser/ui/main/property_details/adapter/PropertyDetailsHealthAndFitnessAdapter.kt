...
class PropertyDetailsHealthAndFitnessAdapter(private val context: Context,
                    private var amenityDetails: List<AmenityDetail>)
    : RecyclerView.Adapter<PropertyDetailsHealthAndFitnessAdapter.ViewHolder>() {

    private  val propertyDetailsHealthAndFitnessIconsList= listOf<Int>(R.drawable.ic_gym,
        R.drawable.ic_gym,R.drawable.ic_gym)
