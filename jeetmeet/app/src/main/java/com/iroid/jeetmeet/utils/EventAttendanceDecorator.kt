...
class EventAttendanceDecorator(private val context: Activity?, dates: ArrayList<CalendarDay>) : DayViewDecorator
{
    ...
    init {
        ...
        drawable = ContextCompat.getDrawable(context!!, R.drawable.sample_green)
