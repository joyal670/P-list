...
class AdminStudentChatAdapter(private var chatMessages: ArrayList<AdminChatModelClass>) :
    ...
    inner class StudentViewHolder(var binding: RecycleParentMessageParentItemBinding) :
        ...
        fun setModel(chatModel: AdminChatModelClass, position: Int) {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (chatMessages[position].from_admin!!.isBlank()) {
