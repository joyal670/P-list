...
public class WarehousePendingJobsController  implements IWarehousePendingJobsController {

    WarehousePendingJobsControllerCallback mCallback;


    public WarehousePendingJobsController(WarehousePendingJobsControllerCallback callback) {
        mCallback = callback;
    }
    ...
    public void onDriverDetails(String token) {
        ...
        Call<PendingJob> call = api.getPendingJobsWithWarehousingToken(GlobalPreferManager.getString(GlobalPreferManager.Keys.TOKEN_STORAGE, ""));
