...
import com.ashtechlabs.teleporter.ui.dashboard.cargo_dashboard.pojo.CargoLoad;
 ...
 */
public class CargoLoadAdapter extends RecyclerView.Adapter<CargoLoadAdapter.LoadViewHolder> {

    private ArrayList<CargoLoad> loadDetailList;
    private FragmentActivity mContext;
    private ArrayList<String> arrayPackageType, arrayPackageUnit, arrayPackageWeightUnit;


    public CargoLoadAdapter(FragmentActivity context, ArrayList<CargoLoad> loadDetails) {
    ...
    public void onBindViewHolder(LoadViewHolder holder, int position) {
        ...
        CargoLoad loadDetails = loadDetailList.get(position);
